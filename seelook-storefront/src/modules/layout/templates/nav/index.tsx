        ...
        <nav className="content-container txt-xsmall-plus text-ui-fg-subtle flex items-center justify-between w-full h-full text-small-regular">
          ...
          <div className="relative w-auto h-full inset-0 p-2">
            <Suspense fallback={<Skeleton className="h-full bg-red-500 aspect-square" />}>
              <Image src="/in/images/logo.svg" alt="logo" width={80} height={80} className="w-auto h-10 pt-2" loading="lazy" />
            </Suspense>
          </div>
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
            <div className="hidden sm:flex items-center gap-x-10 h-full">
              <LocalizedClientLink
                  href="/search"
                  className="flex items-center text-ui-fg-muted hover:text-ui-fg-base transition duration-200"
                  aria-label="Go to search page"
              ><Search size={20}/><span className={"px-2"}>Search</span>
              </LocalizedClientLink>
            </div>
